...
座席番号1~20 まで対応しております。座席番号を対応させてお使いください。
...
## 使い方
1. [フォーム](#座席の予約) から、情報を選択する
2. Submit ボタンを押す
3. 自分のSlack アカウント宛てにアプリからのダイレクトメッセージが届くので、確認する
4. [座席予約状況を確認するためのスプレッドシート](#実装手順) の「予約した日付」「予約した座席番号」に予約がされているか確認する
